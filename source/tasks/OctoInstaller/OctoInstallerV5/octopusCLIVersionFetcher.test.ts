...
describe("OctopusCLIVersionFetcher tests", () => {
    ...
    test("Get latest minor", () => {
        const fetcher = new OctopusCLIVersionFetcher(["1.0.0", "2.0.0", "2.1.0", "3.0.0"]);
    ...
    test("Get latest patch", () => {
        const fetcher = new OctopusCLIVersionFetcher(["1.0.0", "1.0.3", "2.1.0", "3.0.0"]);
    ...
    test("Get latest not pre-release", () => {
        const fetcher = new OctopusCLIVersionFetcher(["1.0.0", "1.0.3", "2.1.0", "3.0.0", "4.0.0-pre"]);
