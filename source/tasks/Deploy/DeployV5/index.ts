...
new Deploy(getOctopusCliTool(), connection).run(space, project, releaseNumber, deployToEnvironments, deployForTenants, deployForTenantTags, deploymentProgress, additionalArguments);
